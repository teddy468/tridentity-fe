...
export const FavouriteRestaurantsContainer = styled(Box)(({ theme }) => ({
...
export const FavouritedGridItem = styled(Grid)(({ theme }) => ({}));

export const StyledFavouriteSlider = styled(Slider)`
  .slick-list {
    margin: 0px -12px;
    .slick-track {
      margin-left: 0;
